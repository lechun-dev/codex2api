...
| `CODEX_CONVERSATION_RECORDING_ENABLED` | Store user messages and final assistant replies as plaintext in the independent `conversation_records` table; default `true`, commentary/tool-call intermediate output is excluded, and records do not expire automatically |
