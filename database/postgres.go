...
const (
	...
	// Keep the local conversation fields and upstream credential generation in
	// the same insert shape across PostgreSQL, SQLite, and MySQL.
	usageLogInsertColumnCount   = 54
