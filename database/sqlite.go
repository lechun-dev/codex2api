...
func (db *DB) migrateSQLite(ctx context.Context) error {
	...
	columns := []struct {
		...
		{"usage_logs", "session_id", "TEXT DEFAULT ''"},
		{"usage_logs", "conversation_id", "TEXT DEFAULT ''"},
		{"usage_logs", "previous_response_id", "TEXT DEFAULT ''"},
		{"usage_logs", "request_text", "TEXT DEFAULT ''"},
		...
		{"system_settings", "continuous_retry_policy", "TEXT DEFAULT '{\"enabled\":false,\"catch_all\":false,\"categories\":[\"transport\",\"http_429\",\"http_5xx\",\"stream_error\"],\"status_codes\":[],\"error_codes\":[],\"max_duration_seconds\":600}'"},
